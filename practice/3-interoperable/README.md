...
> - dataverse.lv glosārijs: `07-palidziba/02-glosarijs.md`
...
**Autori:** Svetlana Surikova (ORCID [0000-0002-3025-6344](https://orcid.org/0000-0002-3025-6344)), Aleksandrs Koļesovs (ORCID [0000-0003-4470-2453](https://orcid.org/0000-0003-4470-2453)), Gunta Siliņa-Jasjukeviča (ORCID [0000-0002-6493-5396](https://orcid.org/0000-0002-6493-5396)) — visi Latvijas Universitāte

**DOI:** [`10.71782/DATA/SMGJHG`](https://doi.org/10.71782/DATA/SMGJHG)
...
**Autori:** Elisabetta Spinazzola (ORCID [0009-0007-5966-7976](https://orcid.org/0009-0007-5966-7976)), Luciano Prono (ORCID [0000-0003-1507-9092](https://orcid.org/0000-0003-1507-9092)), Eleonora Guanziroli (ORCID [0000-0002-7512-5372](https://orcid.org/0000-0002-7512-5372)), Franco Molteni, Fabio Pareschi (ORCID [0000-0001-8777-7135](https://orcid.org/0000-0001-8777-7135)) — Polytechnic University of Turin (ROR [00bgk9508](https://ror.org/00bgk9508)) un Villa Beretta

**DOI:** [`10.5281/zenodo.15365515`](https://doi.org/10.5281/zenodo.15365515)
...
```
https://dv.dataverse.lv/api/datasets/export?exporter={EXPORTER}&persistentId=doi:{DOI}
```

Kur `{EXPORTER}` ir viens no: `schema.org`, `Datacite`, `oai_dc`, `dataverse_json`, `OAI_ORE`, `dcterms`, `ddi`, `oai_ddi`, `oai_datacite`, `croissant`, `html`.

### 5.2 Zenodo eksporta URL formāts

```
https://zenodo.org/records/{RECORD_ID}/export/{FORMAT}
```
...
|----------|--------------|-----------|
| schema.org JSON-LD | Tas, ko redz Google Dataset Search | Pārbauda, vai nosaukums + apraksts + autors + atslēgvārdi parādās |
| DataCite XML | Tas, ko redz DOI reģistrs un akadēmiskās citēšanas sistēmas | Pārbauda `<subjects>` `subjectScheme` un `valueUri` atribūtus |
| Dublin Core (oai_dc) | Tas, ko redz bibliotēku katalogi un OpenAIRE | Pārbauda pamatlauku aizpildi |
| `dataverse_json` (tikai dv.dataverse.lv) | Iekšējais Dataverse formāts | Pārbauda `keywordVocabulary` un `keywordVocabularyURI` apakšlaukus |
...
### 7.4 Sintēze — I2 trūkumam ir divi slāņi
...
## 8. Salīdzinājuma kontrolsaraksts — pēc sesijas pašpārbaudei

> **NB:** Šī sadaļa ir _pēc sesijas_ pašpārbaudei. **Neaizpildiet to klusuma darba laikā** — 3. sadaļa ir jūsu darbība klusuma laikā; 8. sadaļa ir lasīšana pēc sesijas, lai stiprinātu, ko mehāniski ieraudzījāt demonstrācijā.

### 8.1 Atslēgvārdu lauka struktūra

| Aspekts | QVUERT (humanitāri) | SMGJHG (sociālo zinātņu) | Athar (dzīvības zinātņu) | Atzīmēt savai datu kopai |
|---------|----------------------|----------------------------|----------------------------|----------------------------|
...
| FAIR apakšprincips | Kā tas saistās ar šo bloku |
|---------------------|-----------------------------|
...
## 9. Pēc sesijas — pārbaudiet savas datu kopas paši
...
3. **Padomājiet — kura disciplīnas vārdnīca derētu jūsu atslēgvārdiem?**
   ...
   - ES politika / juridiskie / sabiedriskie pakalpojumi → EuroVoc (`https://eur-lex.europa.eu/browse/eurovoc.html?locale=lv`) — latviešu valodā pieejams
   - Lauksaimniecība / pārtika / pamata bioloģija → AGROVOC (`https://agrovoc.fao.org/`)
   - Sociālo zinātņu (CESSDA-saistītie) → ELSST (`https://elsst.cessda.eu/`)
...
### 10.1 Vārdnīcu reģistri

- **LOV** (Linked Open Vocabularies): <https://lov.linkeddata.es/> — 906 vārdnīcas indeksētas; SPARQL galapunkts; meklēt pēc disciplīnas
- **BARTOC** (Basel Register of Thesauri, Ontologies & Classifications): <https://bartoc.org/> — plašāks tvērums nekā LOV (ietver klasifikācijas un taksonomijas)
- **dataverse.lv glosārijs**: <https://dataverse.lv/glosarijs/> — kursa kanoniskā terminoloģija

### 10.2 SKOSMOS pārlūki

- **Finto.fi**: <https://finto.fi/yso/en/> — Somijas Nacionālās bibliotēkas SKOSMOS instances paraugs
- **GEMET-LV**: <https://www.eionet.europa.eu/gemet/lv/themes/> — vides terminoloģija latviešu valodā

### 10.3 SKOS un RDF specifikācijas

- **W3C SKOS Reference**: <https://www.w3.org/TR/skos-reference/> — kanoniskais avots
- **W3C RDF 1.1 Concepts**: <https://www.w3.org/TR/rdf11-concepts/>
- **W3C Turtle**: <https://www.w3.org/TR/turtle/>

### 10.4 CVOC (Dataverse Controlled Vocabulary plug-in)

- **gdcc/dataverse-external-vocab-support** (skripti + dokumentācija): <https://github.com/gdcc/dataverse-external-vocab-support>
- **Dataverse `:CVocConf` iestatījums**: <https://guides.dataverse.org/en/latest/installation/config.html#cvocconf>
- **Akadēmiskā atsauce:** Myers & Tykhonov (2023), _A Plug-in Approach to Controlled Vocabulary Support in Dataverse_, Zenodo `10.5281/zenodo.8133723`

### 10.5 Linked Data 5-zvaigžņu modelis

- **Berners-Lee 2010**: <https://www.w3.org/DesignIssues/LinkedData.html> — 5-zvaigžņu publicēšanas kāpne (★ līdz ★★★★★)
